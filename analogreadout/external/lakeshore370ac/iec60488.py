"""
The :mod:`lakeshore370ac.iec60488` module implements a IEC 60488-2:2004(E)
compliant interface.
...
:class:`~lakeshore370ac.iec60488.IEC60488` base class. To implement a
`IEC 60488-2`_ compliant device driver, you only have to subclass it and
implement the device specific commands, e.g::

    from lakeshore370ac.driver import Command
    from lakeshore370ac.iec60488 import IEC60488
...
commands is implemented as follows::
    ...
    from lakeshore370ac.driver import Command
    from lakeshore370ac.iec60488 import IEC60488, PowerOn
...
from future.builtins import dict, range, str

from analogreadout.external.lakeshore370ac.driver import Command, Driver
from analogreadout.external.lakeshore370ac.types import (
    Boolean, Integer, Register, String)
