...
implementation might look like::
    ...
    from lakeshore370ac.driver import Driver, Command
    from lakeshore370ac.types import Integer
...
from analogreadout.external.lakeshore370ac.transport import SimulatedTransport
from analogreadout.external.lakeshore370ac import protocol as protocol_module
...
class Command(object):
    ...
    :param protocol: When a protocol (an object implementing the
        :class:`lakeshore370ac.protocol.Protocol` interface) is given,
...
class Driver(object):
    ...
    def __init__(self, transport, protocol=None, *args, **kw):
        ...
        self._protocol = protocol or protocol_module.IEC60488()
...
class CommandSequence(misc.ForwardSequence):
