"""The :mod:`lakeshore370ac.protocol` module implements the intermediate
...
does not care what kind of connection (e.g. ethernet, gpib, serial, ...) is
used to communicate with the device.

The common protocol api is defined by the :class:`lakeshore370ac.Protocol`
class. Custom protocols must implement the :meth:`~.Protocol.query` and
...
from analogreadout.external.lakeshore370ac.transport import Timeout
...
class SignalRecovery(IEC60488):
    ...
    E.g.::
        ...
        >>>from analogreadout.external.lakeshore370ac.protocol import SignalRecovery
